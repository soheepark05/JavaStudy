...
public class B_inDecrease {
	 ...
	 * - ++: 피연산자의 값을 1증가 시키는 연산자(++값; 또는 값++)
	 * - -- :피연산자의 값을 1감소시키는 연산자(--값;) 또는 값--;
	 * - (증감연산자)값 = 전위 연산자로 먼저 증감 연산을 수행하고 다른 연산을 수행한다.
	 * - 값(증감연산자): 후위 연산자로 먼저 다른 연산을 수행하고 증감 연산ㅇ르 수행한다.
	 * 
	 */
	public void method1() {
		int num = 10;
		//전위 연산자 테스트
		System.out.println("증감 연산자 적용 전 num의 값: "+num); //10
		System.out.println("1회 수행 후 값: "+ ++num);//11(num = num+1과같은결과만듬)
		...
		System.out.println("1회 수행 후  num의 값: "+ num++); //13
		System.out.println("1회 수행 후  num의 값: "+ num++); //14
		System.out.println("1회 수행 후  num의 값: "+ num++); //15
